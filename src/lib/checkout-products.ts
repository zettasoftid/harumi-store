...
export const featuredProducts: CheckoutProduct[] = [
  {
    ...
    vendor: 'DASTER',
    image: '/images/products/chocolate-cashew.png',
    variants: [
  ...
  },
  {
    ...
    vendor: 'DASTER',
    image: '/images/products/tongue-scraper.png',
    variants: [
  ...
  },
  {
    ...
    vendor: 'DASTER',
    image: '/images/products/peppermint-mints.png',
    variants: [
  ...
  },
  {
    ...
    vendor: 'SEPATU THRIFTING',
    image: '/images/products/mango-chunks.png',
    variants: [
  ...
  },
  {
    ...
    vendor: 'DASTER',
    image: '/images/products/cereal-hoops.png',
    variants: [
...
export const exclusiveProducts: CheckoutProduct[] = [
  { ...featuredProducts[0], image: '/images/products/nutbutter-chocolate.png', bestSeller: true },
  { ...featuredProducts[1], image: '/images/products/chips-seasalt.png', bestSeller: true },
  { ...featuredProducts[2], image: '/images/products/nutbutter-chocolate.png' },
  { ...featuredProducts[3], image: '/images/products/pasta-lentil.png' },
  { ...featuredProducts[4], image: '/images/products/tahini-raw.png' },
  { ...featuredProducts[5], image: '/images/products/ghee-organic.png' },
]
