...
export default function AdminReports() {
  ...
  return (
    <AdminLayout
      ...
      description="Filter penjualan berdasarkan tanggal dan kategori, lalu export CSV sesuai kebutuhan PRD."
      testBypass={testBypass}
      action={<Button className="rounded-lg bg-rose text-cream hover:bg-rose/90" onClick={exportCsv}><Download /> Export CSV</Button>}
    >
